/**
 * Directiva v-draggable para Vue 3
 * Permite arrastrar ventanas (cards) desde su header (.card-header)
 * como ventanas flotantes independientes.
 */
let maxZIndex = 100;
...
const vDraggable = {
    mounted(el) {
        ...
        header.addEventListener('mousedown', (e) => {
            // No arrastrar si se hizo clic en un control interactivo (botón, input, etc.) dentro del header
